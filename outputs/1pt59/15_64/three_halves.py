...
if __name__ == "__main__":
    ...
    total_parts = 2000 #TODO: change total particles
    num_insertions = 1
    parts_per_insert = total_parts//num_insertions
    dp_in = 15/64 #TODO: change particle diameter
    ...
    params = {
        ...
        'mesh': {
            'pipe': {'file': '../../mesh/three_half_in_pg_reduced_smooth.stl', 'mtype': 'mesh/surface/stress', 'material': steel,
